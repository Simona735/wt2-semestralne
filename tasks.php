...
<div class="text-start">
    <a href="index.php" type="button" class="btn btn-sm btn-outline-primary m-3"><i class="bi bi-arrow-left pe-1"></i>Späť</a>
</div>
<div class="container pt-5 d-flex mx-auto flex-column text-center">
    <table class="table">
        <thead class="table-light">
        <tr>
            <th scope="col" class="text-start">Úloha</th>
            <th scope="col">Prokop <br> Branislav</th>
            <th scope="col">Rendek <br>Michal</th>
            <th scope="col">Richterová <br>Simona</th>
            <th scope="col">Ulrichová <br>Barbora</th>
            <th scope="col">Včelková <br>Edita</th>
        </tr>
        </thead>
        <tbody id="taskTable">
            <tr>
